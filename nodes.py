...
async def init_builtin_extra_nodes():
    ...
    import_failed = []
    for node_file in os.listdir(extras_dir):
        if node_file.endswith(".py") and not await load_custom_node(os.path.join(extras_dir, node_file), module_parent="comfy_extras"):
